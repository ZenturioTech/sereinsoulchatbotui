...
const ChatPage: React.FC<ChatPageProps> = ({ onUpgrade, token, onBackToHome }) => {
    ...
    }, [fetchHistory, isOnline, isInitialCheck]);
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex justify-end space-x-3">
                            <button
                                onClick={cancelNewChat}
                                className="px-4 py-2 rounded-full text-md font-medium text-gray-800 bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 transition-colors"
                            >
                                Cancel
                            </button>
                            <button
                                onClick={confirmNewChat}
                                className="px-4 py-2 rounded-full text-md font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                            >
                                OK, proceed
                            </button>
                        </div>
